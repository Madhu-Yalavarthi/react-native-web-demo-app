...
module.exports = function (webpackEnv) {
	...
	return {
		...
		output: {
			...
			filename: (pathData) => {
				return isEnvProduction ? 'static/js/[name].[contenthash:8].js' : 'static/js/[name].chunk.js';
			},
			// TODO: remove this when upgrading to webpack 5
			// futureEmitAssets: true,
			// There are also additional JS chunk files if you use code splitting.
			chunkFilename: (pathData) => {
				return isEnvProduction ? 'static/js/[name].[contenthash:8].chunk.js' : isEnvDevelopment && 'static/js/[name].chunk.js';
			},
